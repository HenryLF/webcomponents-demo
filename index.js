    ...
    class CustomElement extends HTMLElement {
      ...
      connectedCallback() {
        ...
        this.data = module_default.reactive({
          ...
          $attr: (arg) => this.attributes.getNamedItem(arg),
          $slot: (arg) => this.querySelector(`*[slot = ${arg}]`),
          $$slot: (...args2) => queryForSlot(this, ...args2),
          $emit: (name2, detail) => dispatchCustomEvent(this, name2, detail),
          $emitWindow: (name2, detail) => dispatchCustomEvent(window, name2, detail),
          ...xData
        });
        ...
        if (Object.hasOwn(this.data, "init") && typeof this.data.init == "function") {
          this.data.init();
        }
      }
    ...
    xDataFactory: () => ({
      init() {
        ...
        this.$("#code").textContent = slots.reduce(
          (html3, slot) => html3 += `${slot.outerHTML}`,
          ""
        );
      }
    })
...
`
  ...
  WebComponentFactory("darkmode-btn", html2, { noShadow: true });
